...
@section('title') View All Vacancies @endsection
...
<div class="page-content">
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">All Vacancy List</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                        href="{{ route('admin.dashboard') }}">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                </li>
                <li><a class="parent-item" href="javascript:">Vacancy</a>&nbsp;<i class="fa fa-angle-right"></i>
                </li>
                <li class="active">View All Vacancies</li>
            </ol>
        </div>
    </div>
    <div class="row">
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ $category->cat_companyName }}
                                                        </td>
                                                        <td>
                                                            {{ $category->cat_expiryDate }}
                                                        </td>
                                                        <td>
                                                            {{ $category->cat_vacancies }}
                                                        </td>
                                                        <td>
                                                            {{ $category->cat_lotNumber }}

                                                        </td>
                                                        <td>
                                                            {{ $category->cat_approvalDate  }}
                                                        ...
                                                        <td>
                                                            ...
                                                            <button href="javascript:" rel="{{$category->id}}"
                                                                rel1="delete-category"
