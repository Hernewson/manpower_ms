...
@section('title') View All Enquiries @endsection
    ...
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            ...
            <ol class="breadcrumb page-breadcrumb pull-right">
                ...
                <li class="active">View All enquiries</li>
            </ol>
        </div>
    </div>
    <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form action="{{route('clientadd',$enquries->id)}}"
                                                                method="POST">
                                                                @csrf
                                                                <input type="hidden" value="{{$enquries->id}}"
                                                                    name="enquiry_id">
                                                            ...
                                                            <a href="{{ route('enquiry.edit', $enquries->id) }}"
                                                                class="btn btn-primary btn-xs">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>

                                                            <button href="javascript:" rel="{{$enquries->id}}"
                                                                rel1="delete-enquiry"
