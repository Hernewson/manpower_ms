				...
				<div class="page-content" style="min-height:583.8889px " >
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Applicant Invoice</div>
							</div>
				    ...
				    <div id="printDiv">
    							...
    							<div class="col-md-6">
    								<div class="pull-left">
    									<address style="margin-top: 20px;">
    										<img src="{{ asset('public\adminAssets\assets\img\logo.png')}}" alt="logo" class="logo-default" style="height:9vh; width:auto;">
    									</address>
    								</div>
    							</div>
    				    	...
    				    	<div class="row container">
    							<div class="col-md-6">
    								<div class="pull-left">
    									To <br>
    									<strong style="font-size: 22px;">{{$student->name}}</strong> <br>
