        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li><a class="parent-item" href="javascript:">Due</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">All Due List</header>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <select name="student"  class="form-control" data-validation="required"
                                                                    ...
                                                                    <option disabled selected>Select a Applicant</option>
