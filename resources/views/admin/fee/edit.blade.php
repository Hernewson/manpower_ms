...
@section('title')  Edit Due  @endsection
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8"> Due Details</header>
                    ...
                    <div class="card-body " id="bar-parent">
                        ...
                        <div class="col-md-6">
                         <div class="form-group">
                            ...
                            <div class="col-md-6">
                            <div class="form-group">
                                <label for="fee" class="col-form-label">Payment Due</label>
