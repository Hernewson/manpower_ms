...
@section('title')  View All Personnel @endsection
        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li><a class="parent-item" href="javascript:">Personnel</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                    <li class="active">View All Personnel</li>
                </ol>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">All Personnel List</header>
                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-6">
                                                    <div class="btn-group">
                                                        <a href="{{route('manpowerform')}}" id="addRow"
                                                   ...
                                                   @foreach($personnel as $value)
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            ...
                                                            <button href="javascript:" rel="{{ $value->id }}" rel1="deletemanpower" class="btn btn-danger btn-xs deleteRecord" >
