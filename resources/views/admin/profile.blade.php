...
@section('title')  My Profile {{ auth()->user()->name }} - Manpower Management System (MMS) @endsection
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">Update Your Profile Information</header>
