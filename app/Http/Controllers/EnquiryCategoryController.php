...
class EnquiryCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $enquiry_category = new EnquiryCategory;
        ...
        $data['cat_companyName']=$data['companyName'];
        $data['cat_expiryDate']=$data['expiryDate'];
        $data['cat_vacancies']=$data['vacancies'];
        $data['cat_countries']=$data['countries'];
        $data['cat_lotNumber']=$data['lotNumber'];
        $data['cat_approvalDate'] =$data['approvalDate'];

        // $enquiry_category->save();
